                            ...
                            <div class="card-body">
                                <div>
                                    <div class="btn-group w-100 mb-2">
                                        <a  class="btn btn-info active" href="${pageContext.request.contextPath}/fenxi.jsp" data-filter="1" > 北京 </a>
                                        <a class="btn btn-info" href="${pageContext.request.contextPath}/shanghai.jsp" data-filter="2"> 上海 </a>
                                ...
                                <div>
                                    <div class="filter-container p-0 row">
                                        <div class="filtr-item col-sm-2"  data-category="1"  data-sort="white sample">
                                            <div class="card-body">
                                                <div id="bie" style="width: 900px;height:500px;"></div>
                                                <script type="text/javascript">

                                                    var bicCharts = echarts.init(document.getElementById('bie'));
                                                    bicCharts.setOption({
                                                        title: {
                                                            text: '岗位类别',
                                                            subtext: '数据占比',
                                                    ...
                                                    //显示一段动画
                                                    bicCharts.showLoading();
                                                    //异步请求数据
                                                    $.ajax({
                                                        type: "post",
                                                        async: true,
                                                        url: '${pageContext.request.contextPath}/getDataShanghai',
                                                        data: [],
                                                        dataType: "json",
                                                        success: function (result) {
                                                            bicCharts.hideLoading();//隐藏加载动画
                                                            bicCharts.setOption({
                                                                title: {
                                                                    text: '岗位类别',
                                                                    subtext: '数据占比',
                                            ...
                                            <div class="card-body">
                                                <div id="biee" style="width: 900px;height:500px;"></div>

                                                <script type="text/javascript">

                                                    var bieCharts = echarts.init(document.getElementById("biee"));
                                                    //设置属性
                                                    bieCharts.setOption({
                                                        title: {
                                                            text: '不同岗位平均工资',
                                                    ...
                                                    $.ajax({
                                                        ...
                                                        url: "${pageContext.request.contextPath}/getDataGongZiS",    //请求发送到TestServlet处
                                            ...
                                            <div class="card-body">
                                                <div id="bid" style="width: 900px;height:500px;"></div>
                                                ...
                                                <script type="text/javascript">
                                                    ...
                                                    var bieChartss = echarts.init(document.getElementById("bid"));
