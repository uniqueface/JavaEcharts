                            ...
                            <div class="card-body">
                                <div>
                                    <div class="btn-group w-100 mb-2">
                                        ...
                                        <a class="btn btn-info active" href="${pageContext.request.contextPath}/wuhan.jsp" data-filter="5"> 武汉 </a>
                                    </div>
                                    <div class="mb-2">
                                ...
                                <div>
                                    <div class="filter-container p-0 row">
                                        <div class="filtr-item col-sm-2" data-category="5"  data-sort="white sample">
                                            <div class="card-body">
                                                ...
                                                <script type="text/javascript">
                                                    ...
                                                    $.ajax({
                                                        type: "post",
                                                        async: true,
                                                        url: '${pageContext.request.contextPath}/getDataWu',
                                                        data: [],
                                                        dataType: "json",
                                            ...
                                            <div class="card-body">
                                                ...
                                                <script type="text/javascript">
                                                    ...
                                                    $.ajax({
                                                        ...
                                                        url: "${pageContext.request.contextPath}/getDataGongWu",    //请求发送到TestServlet处
