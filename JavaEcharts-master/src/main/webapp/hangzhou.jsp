                            ...
                            <div class="card-body">
                                <div>
                                    <div class="btn-group w-100 mb-2">
                                        ...
                                        <a class="btn btn-info active" href="${pageContext.request.contextPath}/hangzhou.jsp" data-filter="4"> 杭州 </a>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <script type="text/javascript">
                                                    ...
                                                    $.ajax({
                                                        type: "post",
                                                        async: true,
                                                        url: '${pageContext.request.contextPath}/getDataHang',
                                                        data: [],
                                                        dataType: "json",
                                            ...
                                            <div class="card-body">
                                                ...
                                                <script type="text/javascript">
                                                    ...
                                                    $.ajax({
                                                        ...
                                                        url: "${pageContext.request.contextPath}/getDataGongHang",    //请求发送到TestServlet处
