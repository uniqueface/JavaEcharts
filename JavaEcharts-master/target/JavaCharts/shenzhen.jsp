                            ...
                            <div class="card-body">
                                <div>
                                    <div class="btn-group w-100 mb-2">
                                        ...
                                        <a class="btn btn-info active" href="${pageContext.request.contextPath}/shenzhen.jsp" data-filter="3"> 深圳</a>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <script type="text/javascript">
                                                    ...
                                                    $.ajax({
                                                        type: "post",
                                                        async: true,
                                                        url: '${pageContext.request.contextPath}/getDataShen',
                                                        data: [],
                                                        dataType: "json",
                                            ...
                                            <div class="card-body">
                                                ...
                                                <script type="text/javascript">
                                                    ...
                                                    $.ajax({
                                                        ...
                                                        url: "${pageContext.request.contextPath}/getDataGongShen",    //请求发送到TestServlet处
